...
public class Main {
        ...
        public static void main(String[] args) throws IOException, InterruptedException {
            ...
            System.out.println("Swip completed");
            ...
            driver.findElement(By.xpath("//*[contains(@hint,'Eg: Krishna Sweets')")).sendKeys("Sk auto");

            driver.findElement(By.xpath("//android.view.View[@content-desc='Basic Information Organisation Name Business Type Business Category Opening Balance (Optional) Business Location']/android.view.View[0]")).click();
